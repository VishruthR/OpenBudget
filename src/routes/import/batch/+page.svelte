...
<!--         Select the bank account which you want to import transactions for -->
<!--       </p> -->
<!--     </div> -->
<!---->
...
<!--       <p class="paragraph step-description"> -->
<!--         Upload the file containing your transaction data -->
<!--       </p> -->
<!--     </div> -->
<!---->
...
<!--       <p class="paragraph step-description"> -->
<!--         Take a moment to review the transactions you've imported. If any fields -->
<!--         are incorrect or missing, click on them to manually edit. -->
<!--       </p> -->
<!--     </div> -->
<!---->
